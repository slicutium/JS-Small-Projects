...
form.addEventListener('submit', (e)=>{
  //prevent default behaviour, forms tendo to submit to a server
  e.preventDefault();

  //all inputs are of type string, 
  //no matter if we selected type number in the input
  ...
  //empty value
  //negative value
  //more than our array length
  //we will display one paragraph
